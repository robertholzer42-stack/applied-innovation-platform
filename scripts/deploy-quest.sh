#!/usr/bin/env bash
# Install PridefallUnity/Builds/quest.apk on the single connected Quest and launch it.
...
APK="PridefallUnity/Builds/quest.apk"
APP_ID="${VRFORGE_APP_ID:-com.meridian.pridefall}"
